                ...
                <div class="col-sm-2 col-xs-12 padding-box">
                    <div class="row">
                        <div class="col-xs-12 main-box-1-1">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h3 class="box-head">Annual Leaves</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12  main-box-1-2">
                            <h4 class="box-count">00/30</h4>
                        </div>
                    </div>
                </div>
                <div class="col-sm-1 col-xs-12 padding-box"></div>
                ...
                <div class="col-sm-2 col-xs-12 padding-box">
                    <div class="row">
                        <div class="col-xs-12 main-box-2-1">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h3 class="box-head">Casual Leaves</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-2 col-xs-12 padding-box">
                    <div class="row">
                        <div class="col-xs-12 main-box-3-1">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h3 class="box-head">Half Days</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-2 col-xs-12 padding-box">
                    <div class="row">
                        <div class="col-xs-12 main-box-4-1">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h3 class="box-head">Short Leaves</h3>
                                </div>
                            </div>
                        </div>
                    </div>
