...
<div class="list-group" style="margin-top:-10px;">
    ...
    <a href="../site/leave_status.php" style="<?php if($empRole=="director"){echo "display:none;";}?>" class="list-group-item left-menu left-menu<?php if($var=="status"){echo"-active";}?>"><i class="fa fa-building icon-bar" aria-hidden="true"></i>Leave Status<span class="<?php if($var=="status"){echo"selected";}?>"></span></a>
