				...
				<div class="row padding-row">
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="margin-top col-xs-12 nortification-box-top">
                            ...
                            ?>
                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo ($timesum/$workinghours)*100;?>%;" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo ($timesum/$workinghours)*100;?>%;"><?php echo ($timesum/$workinghours)*100;?>%
                                </div>
                            </div>
