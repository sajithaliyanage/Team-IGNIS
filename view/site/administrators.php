...
$sql="SELECT * FROM admin JOIN employee ON admin.comp_id=employee.comp_id JOIN job_category ON employee.job_cat_id=job_category.job_cat_id
      JOIN department ON department.dept_id= admin.dept_id ";
