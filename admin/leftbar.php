...
<div class="list-group" style="margin-top:10px;">
            <a href="index.php" class="list-group-item left-menu left-menu<?php if($var=="index"){echo"-active";}?>"><i class="fa fa-building icon-bar" aria-hidden="true"></i>Overall Company</a>
            <a href="department.php" class="list-group-item left-menu left-menu<?php if($var=="department"){echo"-active";}?>"><i class="fa fa-user-plus icon-bar" aria-hidden="true"></i>Edit Employees</a>
