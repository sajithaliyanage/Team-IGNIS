        ...
        $.fn.jalendar = function (options) {
            ...
            $this.append(
                ...
                div('div', 'jalendar-wood').append(
                    div('div', 'close-button').css({'margin-top':'20px','margin-left':'50px !important'}).html('X'),
                    ...
                    div('div', 'add-event').append(
                        div('div', 'add-new').append(
                            ...
                            div('div', 'submit').html(''), //ad icon here
                            div('div', 'clear'),
            ...
            function calcMonth() {
                ...
                $this.find('.added-event').each(function(i){
                    ...
                    $this.find('.day').has('.event-single').addClass('have-event').prepend(div('i','').css('background-color','#3498db'));
                });
